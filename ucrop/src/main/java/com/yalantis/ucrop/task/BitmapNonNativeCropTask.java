 ...
 */
public class BitmapNonNativeCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    public BitmapNonNativeCropTask(@NonNull Context context, @Nullable Bitmap viewBitmap, @NonNull ImageState imageState, @NonNull CropParameters cropParameters,
