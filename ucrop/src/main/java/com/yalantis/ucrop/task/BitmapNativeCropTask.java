 ...
 */
public class BitmapNativeCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    public BitmapNativeCropTask(@Nullable Bitmap viewBitmap, @NonNull ImageState imageState, @NonNull CropParameters cropParameters,
